...
let cached: { cfg: Config | null; transporter: Transporter | null } = {
  cfg: null,
  transporter: null,
};

function getTransporter(cfg: Config): Transporter | null {
  if (cached.cfg === cfg && cached.transporter !== null) return cached.transporter;
