...
const ACTION_META: Record<string, { label: string; color: string; icon?: string }> = {
  ...
  company_created: { label: "Entreprise créée", color: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" },
  company_updated: { label: "Entreprise modifiée", color: "bg-blue-500/10 text-blue-600 dark:text-blue-400" },
  company_disabled: { label: "Entreprise désactivée", color: "bg-rose-500/10 text-rose-600 dark:text-rose-400" },
  company_deleted: { label: "Entreprise supprimée", color: "bg-rose-500/15 text-rose-700 dark:text-rose-300 font-bold" },
